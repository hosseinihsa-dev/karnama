const C = 'karnama-v42';
const FILES = ['./', './index.html', './core.js?v=42', './study.js?v=42', './views.js?v=42', './style.css?v=42', './manifest.json?v=42', './icon-192.png?v=42', './icon-512.png?v=42', './icon-maskable.png?v=42', './logo-karnama.png?v=42'];
