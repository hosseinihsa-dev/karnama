const C = 'karnama-v39';
const FILES = ['./', './index.html', './core.js?v=39', './study.js?v=39', './views.js?v=39', './style.css?v=39', './manifest.json?v=39', './icon-192.png?v=39', './icon-512.png?v=39', './icon-maskable.png?v=39', './logo-karnama.png?v=39'];
