const C = 'karnama-v46';
const FILES = ['./', './index.html', './core.js?v=46', './study.js?v=46', './decision.js?v=46', './views.js?v=46', './style.css?v=46', './manifest.json?v=46', './icon-192.png?v=46', './icon-512.png?v=46', './icon-maskable.png?v=46', './logo-karnama.png?v=46'];
