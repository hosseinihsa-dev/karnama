const C = 'karnama-v43';
const FILES = ['./', './index.html', './core.js?v=43', './study.js?v=43', './views.js?v=43', './style.css?v=43', './manifest.json?v=43', './icon-192.png?v=43', './icon-512.png?v=43', './icon-maskable.png?v=43', './logo-karnama.png?v=43'];
