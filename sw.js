const C = 'karnama-v35';
const FILES = ['./', './index.html', './core.js?v=35', './study.js?v=35', './views.js?v=35', './style.css?v=35', './manifest.json?v=35', './icon-192.png?v=35', './icon-512.png?v=35', './icon-maskable.png?v=35', './logo-karnama.png?v=35'];
