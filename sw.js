const C = 'karnama-v40';
const FILES = ['./', './index.html', './core.js?v=40', './study.js?v=40', './views.js?v=40', './style.css?v=40', './manifest.json?v=40', './icon-192.png?v=40', './icon-512.png?v=40', './icon-maskable.png?v=40', './logo-karnama.png?v=40'];
