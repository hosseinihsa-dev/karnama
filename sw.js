const C = 'karnama-v47';
const FILES = ['./', './index.html', './core.js?v=47', './study.js?v=47', './decision.js?v=47', './views.js?v=47', './style.css?v=47', './manifest.json?v=47', './icon-192.png?v=47', './icon-512.png?v=47', './icon-maskable.png?v=47', './logo-karnama.png?v=47'];
