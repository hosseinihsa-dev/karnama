const C = 'karnama-v41';
const FILES = ['./', './index.html', './core.js?v=41', './study.js?v=41', './views.js?v=41', './style.css?v=41', './manifest.json?v=41', './icon-192.png?v=41', './icon-512.png?v=41', './icon-maskable.png?v=41', './logo-karnama.png?v=41'];
