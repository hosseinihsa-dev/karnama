const C = 'karnama-v37';
const FILES = ['./', './index.html', './core.js?v=37', './study.js?v=37', './views.js?v=37', './style.css?v=37', './manifest.json?v=37', './icon-192.png?v=37', './icon-512.png?v=37', './icon-maskable.png?v=37', './logo-karnama.png?v=37'];
