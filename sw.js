const C = 'karnama-v34';
const FILES = ['./', './index.html', './core.js?v=34', './study.js?v=34', './views.js?v=34', './style.css?v=34', './manifest.json?v=34', './icon-192.png?v=34', './icon-512.png?v=34', './icon-maskable.png?v=34', './logo-karnama.png?v=34'];
