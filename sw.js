const C = 'karnama-v44';
const FILES = ['./', './index.html', './core.js?v=44', './study.js?v=44', './views.js?v=44', './style.css?v=44', './manifest.json?v=44', './icon-192.png?v=44', './icon-512.png?v=44', './icon-maskable.png?v=44', './logo-karnama.png?v=44'];
