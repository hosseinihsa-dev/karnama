const C = 'karnama-v36';
const FILES = ['./', './index.html', './core.js?v=36', './study.js?v=36', './views.js?v=36', './style.css?v=36', './manifest.json?v=36', './icon-192.png?v=36', './icon-512.png?v=36', './icon-maskable.png?v=36', './logo-karnama.png?v=36'];
