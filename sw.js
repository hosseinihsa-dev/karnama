const C = 'karnama-v38';
const FILES = ['./', './index.html', './core.js?v=38', './study.js?v=38', './views.js?v=38', './style.css?v=38', './manifest.json?v=38', './icon-192.png?v=38', './icon-512.png?v=38', './icon-maskable.png?v=38', './logo-karnama.png?v=38'];
